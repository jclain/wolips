...
public class XB {
    ...
    public static final StringBuilder appendProcessingInstruction(StringBuilder sb, String name,
            XMLAttributes attrs) {
        sb.append("<?");
        sb.append(name);
    ...
    public static final StringBuilder appendStartTag(StringBuilder sb, String name,
            XMLAttributes attrs, boolean empty, boolean closed) {
        sb.append('<');
        sb.append(name);
        appendAttributes(sb, attrs);
        if (empty) sb.append(" /");
    ...
    public static final String getStartTag(String name, XMLAttributes attrs, boolean empty,
            boolean closed) {
