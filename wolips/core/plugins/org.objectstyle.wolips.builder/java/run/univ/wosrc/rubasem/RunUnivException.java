...
public class RunUnivException extends Exception {
	...
	/**
	 * Retourner la cause de cette exception si elle est de type cls,
	...
	/**
	 * Retourner la cause de cette exception si elle est de type cls ET si cette
	 * exception ne contient pas de message (i.e. {@link #getMessage()}==
	 * <code>null</code>) , <code>null</code> sinon.
	 */
